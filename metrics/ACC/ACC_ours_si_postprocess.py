"""
Compute ACC for our_si_postprocess ensemble mean vs ERA5.
File layout: our_si_postprocess/pangu_plasim_pp_si_infer_v1_24h_45step_{YYYYMMDDHHH}_ens_N.nc
  - shape (46_leads, [level,] 180, 360)
  - latitude: south-to-north (-89.5 ... 89.5), same as ERA5 and clim
  - time units: days since init date
  - variables: 2m_temperature, geopotential (17 levels), total_precipitation_24hr
"""
...
PRED_DIR    = '/glade/derecho/scratch/bgong/our_si_postprocess'
...
RESULTS_DIR = '/glade/work/bgong/benchmark-dev/metrics/ACC/results_ours_si_postprocess/'
MAX_LEAD    = 45
...
def list_init_dates():
    prefix = 'pangu_plasim_pp_si_infer_v1_24h_45step_'
    suffix = '_ens_0.nc'
    return sorted(set(
...
def ens_files_for_init(init_str):
    prefix = f'pangu_plasim_pp_si_infer_v1_24h_45step_{init_str}_ens_'
    return sorted(
